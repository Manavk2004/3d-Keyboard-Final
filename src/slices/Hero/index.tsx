  ...
  return (
    ...
    >
      ...
      <div className="hero-content absolute inset-x-0 top-0 h-dvh">
        ...
        <Bounded fullWidth className="hero-body opacity-0 absolute bottom-0 inset-x-0 md:right-[8vw] md:left-auto" innerClassName="flex flex-col gap-3">
          <div className="max-w-md ">
            <PrismicRichText field={slice.primary.body} components={{
              heading2: ({children}) => ( <h2 className="font-bold-slanted mb-1 text-4xl uppercase lg:mb-2 lg:text-6xl">
                {children}
              </h2>) 
            }}/>
          </div>
          <button className="font-bold-slanted flex w-fit cursor-pointer items-center gap-1 rounded bg-[#01a7e1] px-3 py-1 text-2xl uppercase transition disabled:grayscale group">  
