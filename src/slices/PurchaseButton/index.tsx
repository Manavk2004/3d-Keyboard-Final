  ...
  return (
    ...
    >
      <FadeIn className="relative mx-auto max-w-7xl px-4 text-center" targetChildren>
        ...
        <h2 id="buy-button" className="font-bold-slanted mb-8 screoll-pt-6 text-5xl text-gray-900 uppercase md:text-7xl lg:text-8xl">
          <PrismicText field={slice.primary.heading} />
        </h2>
        <button
          onClick={handlePurchaseClick}
          disabled={isPressed}
          className={clsx(`group relative w-full overflow-hidden rounded-full border-8
             border-gray-900 bg-linear-to-r/oklch from-sky-300 to-sky-600 px-6 py-6 ease-out 
             focus:ring-[24px] focus:ring-sky-500/50 focus:outline-none motion-safe:transition-all 
             motion-safe:duration-300 md:border-[12px] md:px-20 md:py-16`,
